...
export default function PrometheusPlanner() {
  ...
  const [aiInsight, setAiInsight] = useState({
    msg: "Welcome, Exile. Allocate your first nodes to begin strategy analysis.",
    type: 'neutral'
  });
      ...
      <header className="border-b border-[#3d3d43] bg-[#0c0c0e] p-4 flex justify-between items-center sticky top-0 z-50 shadow-2xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[9px] text-gray-500 uppercase mt-1">Strategic Build Planner // PoE2 Turnkey</p>
          </div>
        </div>

        <div className="flex gap-8 items-center">
          <div className="hidden md:flex flex-col items-end gap-1">
            <p className="text-[9px] text-gray-500 uppercase font-black tracking-widest text-right">Spirit Reservation</p>
            <div className="flex items-center gap-3">
              <div className="w-40 h-1.5 bg-black rounded-full border border-[#3d3d43] overflow-hidden shadow-inner">
                <div 
                  ...
                  style={{ width: `${stats.spirit}%` }} 
                />
              </div>
              <span className="text-[#7ecce0] font-mono text-xs">{stats.spirit}/100</span>
            </div>
          </div>
          <button className="bg-gradient-to-b from-[#c5a059] to-[#846a3a] text-black px-6 py-2 text-[10px] font-black uppercase tracking-widest shadow-lg">SHARE BUILD</button>
        </div>
      </header>
        ...
        <aside className="col-span-12 lg:col-span-3 space-y-4 overflow-y-auto pr-2 custom-scrollbar">
          ...
          <section className="bg-[#141417] border border-[#3d3d43] p-5 rounded-sm relative bg-[url('https://www.transparenttextures.com/patterns/dark-matter.png')]">
            <h3 className="text-[#c5a059] font-serif text-[10px] uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
              <Zap size={12} /> Live Damage Engine
            </h3>
        ...
        <section className="col-span-12 lg:col-span-9 flex flex-col gap-4">
          ...
          <div className="h-40 bg-[#141417] border border-[#3d3d43] p-5 rounded-sm overflow-hidden">
            ...
            <div className="flex gap-4">
              <div className="px-4 py-3 bg-black/40 border-l-2 border-poe-gold flex items-center gap-3">
                 <Hexagon size={16} className="text-poe-gold fill-poe-gold/20" />
                 <div>
              ...
              <div className="px-4 py-3 bg-black/40 border-l-2 border-poe-spirit flex items-center gap-3">
                 <Zap size={16} className="text-poe-spirit" />
                 <div>
