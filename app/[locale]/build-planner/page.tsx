...
export default function BuildPlannerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0b0f] via-[#050506] to-[#0a0b0f]">
      <div className="max-w-[1900px] mx-auto px-8 py-16">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-400 max-w-2xl">
            Create and optimize your Path of Exile 2 builds with our immersive planning interface.
          </p>
        </div>
